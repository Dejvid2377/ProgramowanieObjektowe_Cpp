...
class Plaskowyz : public BrylaGeometryczna {
    ...
    inline static uint nr_obj_plaskowyz=0;
...
************************************************************************************/
    Plaskowyz(Wektor3D Wsp, double kat);
...
* \param[in] nr_obj_plaskowyz - indywidualny numer przypisany kazdemu nowemu obiektowi*
* \return - lancuch znakowy                          			 	                  *
**************************************************************************************/
    string ZwrocNumerObiektu() { return to_string(nr_obj_plaskowyz); }  
...
* \param[out] - strumien wyjsciowy cout                                             * 
************************************************************************************/
    const char *Nazwa() const override { return "Plaskowyz"; }    
