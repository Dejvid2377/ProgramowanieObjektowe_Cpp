...
template <int T_Rozmiar>
void Wektor<T_Rozmiar>::WyswietlObiekty()
{
  cout << "Aktualna ilosc obiektow Wektor3D: " << this->Zwroc_stworzone() << endl;
  cout << "  Laczna ilosc obiektow Wektor3D: " << this->Zwroc_obecne() << endl << endl;
}
#endif
